(() => {
  ...
  function buildPointLabelItems(scale2, labelSizes, padding) {
    ...
    for (let i = 0; i < valueCount; i++) {
      const pointLabelPosition = scale2.getPointPosition(i, outerDistance + extra + padding[i], additionalAngle);
  ...
  function drawPointLabels(scale2, labelCount) {
    ...
    for (let i = labelCount - 1; i >= 0; i--) {
      ...
      const { x, y, textAlign, left, top, right, bottom } = scale2._pointLabelItems[i];
  ...
  document.addEventListener("DOMContentLoaded", function() {
    let graph = new auto_default(document.getElementById("graph"), {
      type: "line",
      data: {},
      options: {
        plugins: {
    ...
    let graphOutput = new auto_default(document.getElementById("graph-output"), {
      type: "line",
      data: {},
      options: {
        plugins: {
    ...
    let courbe = new auto_default(document.getElementById("courbe"), {
      type: "line",
      data: {},
      options: {
        plugins: {
    ...
    let courbeIntegrale = new auto_default(document.getElementById("courbe-integrale"), {
      type: "line",
      data: {},
      options: {
        plugins: {
    ...
    function runSimul() {
      ...
      function updateCourbes() {
        let { p: p2, integral: integral2, dead: dead2, reset: reset2, bias: bias2, variation: variation2, variation_cool: variation_cool2, variation_heat: variation_heat2, duree: duree2, input: input2, pc: pc2, nb_pt: nb_pt2, d_t: d_t2 } = fetchValues();
        let xs = ["", pc2 - dead2 / 2 - p2 / 2 + " (-PB)", pc2 - dead2 / 2 + "(-DB)", pc2 + " (SP)", pc2 + dead2 / 2 + " (DB)", pc2 + dead2 / 2 + p2 / 2 + " (PB)", ""];
        let ys = [0, 0, bias2, bias2, bias2, 100, 100];
        let ds1 = [
          { x: "", y: 0 },
          { x: pc2 - dead2 / 2 - p2 / 2 + " (-PB)", y: 0 },
          { x: pc2 - dead2 / 2 + "(-DB)", y: bias2 },
          { x: pc2 + " (SP)", y: bias2 },
          { x: pc2 + dead2 / 2 + " (DB)", y: bias2 },
          { x: pc2 + dead2 / 2 + p2 / 2 + " (PB)", y: 100 },
          { x: "", y: 100 }
        ];
        courbe.data = { labels: xs, datasets: [{ data: ds1, pointStyle: "cross" }] };
        courbe.update();
        xs = ["", pc2 - dead2 / 2 - p2 / 2 + " (-RB)", pc2 - dead2 / 2 + "(-DB)", pc2 + " (SP)", pc2 + dead2 / 2 + " (DB)", pc2 + dead2 / 2 + p2 / 2 + " (RB)", ""];
        ys = [-integral2, -integral2, 0, 0, 0, integral2, integral2];
      ...
      graphOutput.data = {
        ...
        datasets: [
          ...
          {
            label: "Cooling",
            data: outs.map((out2) => scale(out2, 50, 0, 100, 100)),
            pointStyle: false,
            borderColor: "#0000FF",
          ...
          {
            label: "Heating",
            data: outs.map((out2) => scale(out2, 0, 100, 50, 0)),
            pointStyle: false,
            borderColor: "#FF0000",
 ...
 * Released under the MIT License
 */
//# sourceMappingURL=/assets/my_charts.js-e65126f8694e408b428a408eb8a0c7f791253eb3616864e72b42a599c2b28c91.map
//!
;
